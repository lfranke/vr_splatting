...
//
// Return [gradient_point, gradient_pose]
HD inline BackwardOutputPinhole ProjectPointPinholeBackwardWoNormal(vec3 p, vec2 grad, Sophus::SE3f V,
...
HD inline BackwardOutputOcamPointsize ProjectPointOcamBackwardPointSize(vec3 p, float pointsize, vec2 grad,
                                                                        Sophus::SE3f V,
                                                                        IntrinsicsPinholef crop_transform,
                                                                        Vector<float, 5> a, ArrayView<const float> poly,
                                                                        float dist_cutoff, Matrix<float, 2, 2> crop_rot)
{
    using T = float;

...
OptimizationParameters read_optim_params_from_json()
{
    ...
    std::filesystem::path json_path = std::filesystem::current_path() / "parameter/optimization_params.json";
    ...
    params.use_densify              = json["use_densify"];
    params.opacity_reset_until_iter = json["opacity_reset_until_iter"];
